export const PillIcon = ({ className = 'w-5 h-5' }) => (
  ...
  >
    ...
    <line x1="7" y1="12" x2="17" y2="12" transform="rotate(-30 12 12)" />
  </svg>
);

export const TelanganaMapIcon = ({ className = 'w-6 h-6' }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="currentColor"
    aria-hidden="true"
  >
    {/* Stylised Telangana map silhouette — replace with actual path when available */}
    <path d="M12 2l6 3.5v6L18 14l-2 2-2.5 5.5L11 16l-2-1.5-2.5-3.5L4 9.5l1.5-4L12 2z" opacity="0.85" />
  </svg>
);
